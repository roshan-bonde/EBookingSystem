INSERT INTO public.bus(
	...
	VALUES (current_timestamp(0), 2000, 30, 'wifi, ac', current_timestamp(0), 'Sharad Bus Services', 12345, 'Slepper', current_timestamp(0), 'Sharad Kumar', 'Nagpur', 'Pune', '1+2', 'Ratnagiri');
